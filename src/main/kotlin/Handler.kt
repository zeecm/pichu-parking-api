...
data class APIGatewayEventPayload(
    @SerializedName("body-json") var body: Map<String, String>,
    @SerializedName("params") var params: Parameters,
    @SerializedName("stage-variables") var stageVariables: Map<String, String>,
    @SerializedName("context") var context: APIGatewayEventContext,
)

data class Parameters(
    @SerializedName("path") var path: Map<String, String>,
    @SerializedName("querystring") var queryString: Map<String, String>,
